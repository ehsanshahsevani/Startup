...
public partial class Branch
    : ComponentBaseMarketplaceFullCustom<BranchResponseViewModel, BranchRequestViewModel>
{
	[Inject] BranchService Service { get; set; } = default!;                          
	
    private ModalImageBranchChanger? _modalImageBranchChanger;
    ...
    private BranchParameters _parameters;

    private string? provinceId;
    
    public Branch() : base()
    {
        _parameters = new BranchParameters();
    ...
    private async Task FindByIdAndMoveToUpdateModeAsync(string id)
    {
        ...
        else
        {
            ...
            await GoToPageAsync(MarketplaceRoutes.Branch(), null);
        }
    }
