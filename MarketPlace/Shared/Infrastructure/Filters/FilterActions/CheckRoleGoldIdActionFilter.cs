...
public class CheckRoleGoldIdActionFilter: InfrastructureSeedworks.ActionFilter.IBaseAsyncActionFilter
{
    public IUnitOfWork UnitOfWork { get; }

    public CheckRoleGoldIdActionFilter(IUnitOfWork unitOfWork)
    {
