...
public class CheckCartItemIdActionFilter : IBaseAsyncActionFilter
{
    public CheckCartItemIdActionFilter(IUnitOfWork unitOfWork)
    {
    ...
    public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
    {
        ...
        else
        {
            var entity =
                await UnitOfWork
                    .CartItemRepository.FindAsync(id);
