...
namespace Persistence.Migrations
{
    ...
    [Migration("20250811085541_UpdatePageSettingNullableName")]
    partial class UpdatePageSettingNullableName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.DocumentDetail", b =>
                {
                    ...
                    b.Property<decimal>("GoldPriceInThisTime")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("GoldSoot")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Domain.GoldTreasuryOnline", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.ToTable("GoldTreasuryOnlines");
                });

            modelBuilder.Entity("Domain.GoldTreasuryReceive", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.ToTable("GoldTreasuryReceives");
                });
            ...
            modelBuilder.Entity("Domain.IncomeCommissionFee", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.ToTable("IncomeCommissionFees");
                });

            modelBuilder.Entity("Domain.IncomeGoldPurchaseFee", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.ToTable("IncomeGoldPurchaseFees");
                });

            modelBuilder.Entity("Domain.IncomeMaintenanceAndInsuranceFee", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.ToTable("IncomeMaintenanceAndInsuranceFees");
                });

            modelBuilder.Entity("Domain.IncomeSaleOfGoldFee", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.ToTable("IncomeSaleOfGoldFees");
                });

            modelBuilder.Entity("Domain.IncomeWalletRechargeFee", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.ToTable("IncomeWalletRechargeFees");
                });
            ...
            modelBuilder.Entity("Domain.PageSetting", b =>
                {
                    ...
                    b.Property<string>("FileOriginalNameIcon")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("Domain.PageSettingTagPageSetting", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.Property<string>("PageSettingId")
                        .IsRequired()
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("TagPageSettingId")
                        .IsRequired()
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.HasIndex("PageSettingId");

                    b.HasIndex("TagPageSettingId");

                    b.ToTable("PageSettingTagPageSetting");
                });
            ...
            modelBuilder.Entity("Domain.TagPageSetting", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("Domain.UserAssets", b =>
                {
                    ...
                    b.Property<decimal>("AssetsGold")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("AssetsWallet")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Domain.PageSettingTagPageSetting", b =>
                {
                    b.HasOne("Domain.PageSetting", "PageSetting")
                        .WithMany("PageSettingTagPageSettings")
                        .HasForeignKey("PageSettingId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Domain.TagPageSetting", "TagPageSetting")
                        .WithMany("PageSettingTagPageSettings")
                        .HasForeignKey("TagPageSettingId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("PageSetting");

                    b.Navigation("TagPageSetting");
                });
            ...
            modelBuilder.Entity("Domain.PageSetting", b =>
                {
                    b.Navigation("PageSettingTagPageSettings");
                });
