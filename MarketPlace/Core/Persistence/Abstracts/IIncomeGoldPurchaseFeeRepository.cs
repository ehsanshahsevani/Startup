...
public interface IIncomeGoldPurchaseFeeRepository : IRepository<IncomeGoldPurchaseFee>
{
	/// <summary>
	...
	/// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
	/// <returns>The income sale of gold fee as a decimal.</returns>
	Task<IncomeGoldPurchaseFee?> FindIncomeAsync(CancellationToken cancellationToken = default);
}