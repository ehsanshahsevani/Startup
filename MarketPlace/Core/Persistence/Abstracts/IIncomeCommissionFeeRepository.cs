...
public interface IIncomeCommissionFeeRepository : IRepository<IncomeCommissionFee>
{
	/// <summary>
	...
	/// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
	/// <returns>The income sale of gold fee as a decimal.</returns>
	Task<IncomeCommissionFee?> FindIncomeAsync(CancellationToken cancellationToken = default);
}