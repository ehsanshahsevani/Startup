...
public interface IIncomeWalletRechargeFeeRepository : IRepository<IncomeWalletRechargeFee>
{
	/// <summary>
	...
	/// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
	/// <returns>The income sale of gold fee as a decimal.</returns>
	Task<IncomeWalletRechargeFee?> FindIncomeAsync(CancellationToken cancellationToken = default);
}