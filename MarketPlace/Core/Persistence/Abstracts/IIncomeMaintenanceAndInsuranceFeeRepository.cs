...
public interface IIncomeMaintenanceAndInsuranceFeeRepository : IRepository<IncomeMaintenanceAndInsuranceFee>
{
	/// <summary>
	...
	/// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
	/// <returns>The income sale of gold fee as a decimal.</returns>
	Task<IncomeMaintenanceAndInsuranceFee?> FindIncomeAsync(CancellationToken cancellationToken = default);
}