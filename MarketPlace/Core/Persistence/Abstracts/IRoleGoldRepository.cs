...
public interface IRoleGoldRepository : IRepository<RoleGold>
{
    /// <summary>
    ...
    /// <returns></returns>
    Task<PagedList<RoleGold>> GetAllInPageAsync(
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<Result> IsOkForAddAsync(RoleGoldRequestViewModel entity, CancellationToken cancellationToken = default);
}