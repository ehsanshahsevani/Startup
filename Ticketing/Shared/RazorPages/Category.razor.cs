...
//     : ComponentBaseMarketplaceFullCustom<CategoryResponseViewModel, CategoryRequestViewModel>
// {
// 	[Inject] CategoryService Service { get; set; } = default!;                          
//     
//     private CategoryParameters _parameters;
//
//     public Category() : base()
//     {
//         _parameters = new CategoryParameters();
//
...
//             await GoToPageAsync(MarketplaceRoutes.Category(), null);
//         }
//     }
//
...
//     }
//
//     private async Task MoveAllProductToRequestForCheckPriceByCategoryIdAsync(string categoryId)
//     {
//         if (_loadingModal is not null)
//         {
//             await _loadingModal.ShowAsync();
...
//                     .MoveAllProductToRequestCheckPriceByCategoryIdAsync(categoryId);
//                 
//                 RequestResultService.AddResult(updateResult);
//
